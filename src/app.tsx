...
export const layout: RunTimeLayoutConfig = ({ initialState }) => {
  return {
    ...
    //       {TWTProps.icon && < IconFont type={TWTProps.icon.toString()} />}{defaultDom}ddddd
    //     </Link>
    //   )
    // },
    ...
    //   return (
    //     <>
    //       {TWTProps.icon && < IconFont type={TWTProps.icon.toString()} />}{TWTProps.name}ddd
    //     </>
    //   )
    // },
    // menuRender :(prop)=>{console.log('menuRender ',prop)},
    // menuDataRender :(prop)=>{console.log('menuDataRender ',prop)},
    // 自定义 403 页面
